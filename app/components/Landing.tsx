...
import { anton, pwrite } from "@/app/lib/fonts";
...
export default function Landing() {
  ...
  return (
    <section className={` tracking-widest relative min-h-[80vh] flex justify-center lg:justify-between flex-col lg:flex-row px-0 md:px-20`}>      
      <Redirect/>            

      {/* Content */}
      {/* <div className="relative z-10 flex justify-between"> */}
        <div className="mb-8 animate-fade-in lg:mt-[2rem] text-center lg:text-left">
          <h1 className={`${anton.className} font-bold text-[3rem] lg:text-[5rem] uppercase  xl:mt-10`}>
            Naachogaao
          </h1>
            <TextGenerateEffect words="Join your favorite creators&apos; music streams " className={`${pwrite.className} max-w-[40rem] mx-auto mt-8`} /> 
            <TextGenerateEffect startDelay={1} words="Add songs, vote for favorites, and experience music together in real-time. 
            The future of social music streaming is here." className={`${pwrite.className} max-w-[40rem] mx-auto mb-12 mt-2`} />
            {/* CTA Buttons */}
            <div className={`${anton.className} flex flex-col justify-center items-center lg:justify-start sm:flex-row gap-4 animate-fade-in delay-500 mt-4`}>
            <SignedOut>
